...
const cuadrados = document.querySelectorAll(".cuadrado"); // se seleccionan los cuadrados de la grilla

const modal = document.querySelector("dialog"); //declaramos la pantalla emergente "modal"
...
cuadrados.forEach((cuadrado, posicion) =>{
    ...
    cuadrado.addEventListener("click", ()=>{ // se hace un evento "click", cada vez que hay un click pasa:
...
function ganar(posicionesGanadoras){
    ...
    mostrarModal("Ganador jugador " + (estadoJuego === "P1" ? "P2" : "P1"));
}
